...
namespace School_management_system
{
    public partial class Dashboard : Form
    {
        ...
        private void Dashboard_Load(object sender, EventArgs e)
        {
            ...
            // Load chart into ReportViewer
            ReportDataSource rds = new ReportDataSource("DataSet2", chartData); // 👈 Must match RDLC dataset name


            reportViewer1.LocalReport.ReportEmbeddedResource = "School_management_system.DashboardChart.rdlc"; // ✅ Replace with real namespace & filename
