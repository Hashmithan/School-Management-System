        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@EDate", DateTime.Now); // 👈 Automatically get current system date & time
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    cmd.Parameters.AddWithValue("@StudentId", Convert.ToInt32(cmbStudentId.SelectedValue));
                    cmd.Parameters.AddWithValue("@Section", cmbSectionName.Text);
                    cmd.Parameters.AddWithValue("@EDate", DateTime.Now); // Auto current date & time
