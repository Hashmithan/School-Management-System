...
namespace School_management_system
{
    public partial class Section : Form
    {
        ...
        public void clearFields()
        {
            ...
            txtCapacity.Clear();
            txtRoomNumber.Clear();
            cmbTeacherId.SelectedIndex = -1; // Clear the ComboBox selection
            lblTeacherName.Text = ""; // Clear the label displaying teacher name
        }
        ...
        // Global flag to avoid triggering event during load
        bool isLoading = true;
